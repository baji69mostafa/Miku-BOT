let handler = m => m; 
 ...
   let responses; 
   if (/^ميكو بحبك|احبك|ميكو عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|ميكو هنتجوز امتي|ميكو انت ليا|ميكو بموت فيك$/i.test(m.text)) { 
     responses = [ 
       '*و أنا أكثر يعمري🫶🏻💗*   ',  
       '*حبتك حية قول آمين!*',  
 ...
     ]; 
   }else if (/^ ميكو عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشبب$/i.test(m.text)) { 
     responses = [ 
