...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*[❗𝐈𝐍𝐅𝐎❗] ارسل رابط المقطع الذي تريد تحميله من الانستغرام, مثال: ${usedPrefix + command}* https://www.instagram.com/reel/CzJ323DIwjt/?igshid=MXViZ2IyN2NnOGZtOA==`;
  m.reply(global.wait);
  try {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            throw `*[❗𝐈𝐍𝐅𝐎❗] حدث خطأ اثناء التحميل ربما المقطع غير صالح*`;
          }
        }
      }
    }
